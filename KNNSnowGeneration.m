...
wCloseAggreTmax=Weights.wCloseAggreTmax; %Tmax ShortTemporal-neighborhood Weights;
wCloseAggreTmin=Weights.wCloseAggreTmin;%Tmin ShortTemporal-neighborhood Weights;
wCloseAggreP=Weights.wCloseAggreP;%Pre ShortTemporal-neighborhood Weights;
wTmax=Weights.wTmax;%Tmax LongTemporal-neighborhood Weights;
wTmin=Weights.wTmin;%Tmin LongTemporal-neighborhood Weights;
wP=Weights.wP;%Pre LongTemporal-neighborhood Weights;
wMODIS=Weights.wMODIS;%MOD10A1 Weights;
wMYD=Weights.wMYD;%MYD10A1 Weights;
wShadow=Weights.wShadow;%Shadow Weights;
wClosestLandsat=Weights.wClosestLandsat;%Nearest 30m SnowMap Weights;
end
